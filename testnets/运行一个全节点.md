...
```
cd $IRISHOME/config/
wget https://gist.github.com/kidinamoto01/792ea4c6a2c2ed29efa4f914cd5fd899
wget https://gist.github.com/kidinamoto01/792ea4c6a2c2ed29efa4f914cd5fd899
```
### 修改配置文件
在config.tmol文件中可以配置以下信息：
* 将`moniker`字段配置称为自定义的名称，这样便于区分不同的节点
* `seed`字段用语设置种子节点，在fuxi-1002中的官方中字节点为：3fb472c641078eaaee4a4acbe32841f18967672c@35.165.232.141:46657
