...
| 2    | Participate in Software upgrade process. You need to Upgrade your sofware to version `v0.10.1` once the specific software upgrade proposal is passed in the future. | Participate in software-upgrade                              | Submit your IP and the team could visit the port of your node | 200    |
| 3    | When running `v0.10.1`, delegate some **iris** to a validator | Get some **iris** from faucet and delegate to a validator    | Run this send transaction with your `name-pgpid` as memo. Submit your transaction hash and the team could verify the details of transaction | 50     |
...
| 2    | When the network come back and your node use`v0.10.1-patch1`, delegate some **iris** to a validator | Get some **iris** from faucet and delegate to a validator    | Run this send transaction with your `name-pgpid` as memo. Submit your transaction hash and the team could verify the details of transaction | 50     |
| 3    | When the network come back and your node use `v0.10.1-patch1`, withdraw some **iris** from reward pool | After you become a validator, you could withdraw your rewards by `iriscli distribution withdraw-rewards` | Run this send transaction with your `name-pgpid` as memo. Submit your transaction hash and the team could verify the details of transaction | 50     |
